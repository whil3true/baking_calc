/* KonditerCalc local icon renderer.
 * Icon geometry is based on Lucide Icons (ISC; some Feather-derived icons MIT).
 * Kept local so calculators have no runtime icon CDN dependency.
 */
(() => {
  'use strict';
  ...
  const iconPaths = {
    ...
    'trash-2': '<path d="M3 6h18"/><path d="M8 6V4h8v2"/><path d="m19 6-1 15H6L5 6"/><path d="M10 11v6"/><path d="M14 11v6"/>',
  ...
  const fallback = '<circle cx="12" cy="12" r="10"/><path d="M9 12h6"/><path d="M12 9v6"/>';
